...
public class ErroSintatico implements Dicionario {
    ...
    /**
     * Construtor para erros esperados, ou seja, esperava-se X elemento e
     * recebeu Y elemento.
     *
    ...
    /**
     * Construtor utilizado sempre que houver entradas que nao sao esperadas
     * pelo programa Entra nos casos que o programador adiciona coisas alem do
     * que deveria.
     *
     * @param tokenObtido token obtido
